...
print (files)
print(len(files))
#boucle pour parcourir mes fichiers dans le dossier 2016/318/station/type_sat
for i in range(0,len(files)) :
    ...
    # au cas où le satellite n'est pas passé au dessus du séisme au bon moment 
    ...
    az = np.radians(az)
    #obligé de passer en radians maintenant sinon mauvaise sélection avant
    elevation  = np.radians(elevation)
    # Calcul latitude et longitude du satelite    
...
#def animate(i):
#    x, y = bmap(np.degrees(lon_total),np.degrees(lat_total))
#    point.set_data(x, y)
#    return point,
#
